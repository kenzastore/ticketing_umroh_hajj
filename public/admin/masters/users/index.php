...
async function loadData() {
    ...
    try {
        const response = await fetch(`../../../api/users.php?page=${currentPage}&limit=${limit}&_=${new Date().getTime()}`);
...
function renderPagination(p) {
    ...
    </ul></nav><div class="text-center text-muted small">Showing ${p.totalItems} total users</div>`;
