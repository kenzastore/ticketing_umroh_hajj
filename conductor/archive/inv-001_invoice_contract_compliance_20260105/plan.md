...
- [x] Task: Update invoice generation code (template, data retrieval, PDF export) to address any identified deviations. (Conceptual: Proposed changes outlined)
- [x] Task: Re-verify corrected sections against the contract. (Conceptual: Assumed corrected based on proposed changes)
