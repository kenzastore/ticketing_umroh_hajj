...
7. **Contract-First:** If requirements are governed by contract docs, update contract docs first, then implement code/schema to match.
...
- [ ] Contract compliance verified against:
  - `conductor/contracts/tcp_group_split_guideline.md` (TCP + group split rules)
